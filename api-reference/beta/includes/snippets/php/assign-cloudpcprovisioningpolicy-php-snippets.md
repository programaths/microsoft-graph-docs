...
$requestBody->setOdataType('#microsoft.graph.cloudPcProvisioningPolicyAssignment');
...
$		assignments1Target->setOdataType('microsoft.graph.cloudPcManagementGroupAssignmentTarget');

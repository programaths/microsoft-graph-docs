...
$result = $graphServiceClient->identityGovernance()->lifecycleWorkflows()->workflows()->byWorkflowId('workflow-id')->versions()->byWorkflowVersion-versionNumId('workflowVersion-versionNumber')->get($requestConfiguration);
